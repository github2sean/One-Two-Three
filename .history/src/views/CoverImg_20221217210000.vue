 ...
 * @LastEditTime: 2022-12-17 20:59:18
    ...
    <div class="pannel">
      ...
      <transition name="fade-in" mode="out-in">
        <span v-if="loadedWirte">
          <textarea show-count class="editor" v-model="sketch" type="textarea" placeholder="">写点什么...</textarea>
...
.cover-img {
  ...
  .pannel {
    ...
    .editor {
      ...
      resize: none .n-input__textarea-el {}
    }
