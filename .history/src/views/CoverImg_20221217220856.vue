 ...
 * @LastEditTime: 2022-12-17 22:08:32
      ...
      <transition name="fade-in" mode="out-in">
        <div v-show="loadedWirte">
          ...
          <div class="operate">
            ...
            <n-button size="small"  type="primary" class="write">
              <i class="fa fa-paper-plane fa-fw"></i>
            </n-button>
            <svg @click="write" data-v-5601c235="" width="44" height="28" viewBox="0 0 44 28" fill="none"
              xmlns="http://www.w3.org/2000/svg" class="saveBtn" style="cursor: pointer;">
              <rect data-v-5601c235="" width="44" height="27.0769" rx="6" fill="#55BB8E"></rect>
              <path data-v-5601c235=""
